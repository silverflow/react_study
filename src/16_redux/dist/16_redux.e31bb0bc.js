...
var initialState = {
  toggle: false,
  counter: 0
}; // state가 undefinded일 대는 initialState를 기본값으로 사용
...
render();
store.subscribe(render); // 상태가 업데이트될 때마다 render 함수를 호출
...
},{"redux":"../../node_modules/redux/es/redux.js"}],"../../../../.nvm/versions/node/v14.17.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
